    ...
    <ThemeContext.Provider value = {themeHook}>
      <View style={styles.container}>
        ...
        <View style={styles.cardsView}>
          <MainCard title={"morning"} icon={'morning'} temperature={"27°"} backgroundColor={ darkTheme ?'#D26F2F' : '#CC6E30'} ></MainCard>
          <MainCard title={"afternoon"} icon={'afternoon'} temperature={"31°"} backgroundColor={darkTheme ? '#D29600'  : '#FCC63F'} ></MainCard>
          <MainCard title={"night"} icon={'night'} temperature={"21°"} backgroundColor={darkTheme ? '#008081'  : '#38B7B8'} ></MainCard>
        </View>
    
        <View style={styles.info}>
          <Text style={styles.infoText}>Additional Information:</Text>
          <View style={styles.addtionalInfo}>
            <InfoCard title={'Wind'} variable={wind} ></InfoCard>
            <InfoCard title={'Moisture'} variable={humidity} ></InfoCard>
